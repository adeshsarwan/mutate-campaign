    ...
    revenue_by_user AS (
      SELECT
        ...
        SUM(IF(b.event_name = 'ad_impression' AND b.event_date BETWEEN a.acquisition_date AND @end_date,
               COALESCE(b.event_value_in_usd, 0), 0)) AS revenue_total_usd,
...
def main() -> None:
    ...
    result = {
        ...
        "definitions": {
            ...
            "ltv": "Cumulative GA4 event_value_in_usd from ad_impression events generated by the acquired cohort.",
